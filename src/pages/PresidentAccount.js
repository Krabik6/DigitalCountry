...
const PresidentAccount = () => {
  ...
  return (
    <div className='account-main'>
      ...
      <input className='input-change' onChange={e => setNewUserAddress(e.target.value)} placeholder="address" /> 
      <input className='input-change' onChange={e => setNewUserName(e.target.value)} placeholder="New name" /> 
      ...
      <input className='input-change' onChange={e => setNewGovernmentAddress(e.target.value)} placeholder="address" /> 
      <input className='input-change' onChange={e => setNewGovernmentName(e.target.value)} placeholder="name" /> 
